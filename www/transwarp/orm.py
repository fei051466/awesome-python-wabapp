			...
			if isinstance(v, Field):
				...
				if v.primary_key:
					...
					if v.updatable:
						...
						v.updatable = False
					if v.nullable:
						logging.waring('NOTE: change primary key to non-nullable.')
						v.nullable = False
					primary_key = v
				mappings[k] = v
...
class Model(dict):
	...
	'''
	__metaclass__ = ModelMetaClass #what is this????
	...
	def find_first(cls, where, *args):
		...
		only the fist one returned. If no result found, return None.
		'''
